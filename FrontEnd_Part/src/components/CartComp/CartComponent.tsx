...
import { removeOneItem, loadCartFromLoacl } from '../../Slices/CartSlice'
                        ...
                        <div className="ml-4 flex flex-1 flex-col">
                          ...
                          <div className="flex flex-1 items-end justify-between text-sm">
                            ...
                            <div className="flex">
                              <button
                                type="button"
                                className="font-medium text-red-600 hover:text-red-500 rounded p-1 hover:border hover:border-red-500"
                                onClick={() => { dispatch(removeOneItem({ id: product.id })) }}
                              >
                                Remove
                              </button>
                            </div>
