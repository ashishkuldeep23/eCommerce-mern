...
import { NewProductInput, TypeObj } from "../../Type/type";
...
function CreateNewProduct() {
  ...
  const [plusCategoryInput, setPlusCategoryInput] = useState<{
    typing: string;
    added: string;
  }>({ typing: "", added: "" });
  ...
  const onSubmit: SubmitHandler<NewProductInput> = (data) => {
    ...
    if (!productHighlight) {
      setError("description.highLights", {
        type: "manual",
        message: "Give Highlights of product.",
      });
    } else {
  ...
  useEffect(() => {
    ...
    if (updatingProduct) {
      ...
      let highlightFormate = newProduct.description?.highLights!.reduce(
        (acc, cur) => `${acc},${cur}`,
      );
        ...
        <form
                  ...
                  <div>
                    {plusCategoryInput.added && (
                      <p
                        ...
                        className="mx-2">
                        Fill out the rest of form, new category will be created
...

                    {
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          ...
                          setPlusCategoryInput({
                            typing: "",
                            added: plusCategoryInput.typing,
                          });
          ...
          <div>
            ...
            <div className=" w-full px-0.5 mt-3">
              ...
              <div className=" mt-2">
                <textarea
                  ...
                  className={`block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-gray-300  focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${!themeMode ? " bg-white text-gray-900 " : "bg-gray-900 text-white"}`}></textarea>
            ...
            <div className=" w-full px-0.5 mt-3">
              ...
              <div className="mt-2">
                ...
                />
                <p className=" text-[0.7rem] pl-2 ">
                  **Give multiple highlights about product seprated by comma(,)
                </p>
              </div>
            ...
            <div className=" flex flex-wrap flex-col md:flex-row">
              <p
                ...
                {" "}
                <span className=" underline">NOTE</span> : Value give in this
                (width;5mm,height;5mm,length;5mm) formate. key value pair
                seprate by semicolon(;) and next item seprate by comma(,)
              </p>
                ...
                <div className="mt-2 flex flex-col">
                  <div className="flex flex-col">
                    <div>
                      ...
                      <p className="text-sm pl-2 text-red-500 font-bold">
                        {" "}
                        {errors.description?.specifications?.message}{" "}
                      </p>

                      <p className=" text-[0.7rem] pl-2 ">
                        **Use this formate (Pack of;1,Designed by;Brand)
                      </p>
                    </div>
                    ...
                    <div>
                      {makeActualValueFormate(productSpecs).length > 0 ? (
                        makeActualValueFormate(productSpecs).map((ele, i) => {
                          return (
                            <p key={i}>
                              👉{`${Object.keys(ele)} - ${Object.values(ele)}`}
                            </p>
                          );
                        })
                      ) : (
                ...
                <div className="mt-2 flex flex-col">
                  <div>
                    <input
                      ...
                      value={productDimen}
                      onChange={(e) => {
                        setProductDimen(e.target.value);
                      }}
                      // name="email"
                      type="text"
                    ...
                    <p className="text-sm pl-2 text-red-500 font-bold">
                      {" "}
                      {errors.description?.dimensions?.message}{" "}
                    </p>

                    <p className=" text-[0.7rem] pl-2 ">
                      **Use this formate (width;5mm,height;5mm,length;5mm)
                    </p>
                  </div>
                ...
                <div className="mt-2 flex flex-col">
                  <div>
                    <input
                      ...
                      onChange={(e) => {
                        setProductDetailOfDes(e.target.value);
                      }}
                      // name="email"
                      type="text"
                      placeholder="Dimentions of Product (width;5mm,height;5mm,length;5mm) use this formate."
                    ...
                    <p className="text-sm pl-2 text-red-500 font-bold">
                      {" "}
                      {errors.description?.product_Details?.message}{" "}
                    </p>

                    <p className=" text-[0.7rem] pl-2 ">
                      **Use this formate (Ideal For;Men Women Kids,
                      Shape;Rectangular)
                    </p>
                  </div>
                  ...
                  <div>
                    {makeActualValueFormate(productDetailOfDes).length > 0 ? (
                      makeActualValueFormate(productDetailOfDes).map(
                        (ele, i) => {
                          return (
                            <p key={i}>
                              👉{`${Object.keys(ele)} - ${Object.values(ele)}`}
          ...
          <div className=" w-full px-0.5 mt-3">
            <p
              className="bg-red-300 px-2 mt-5 rounded"
              style={{ lineBreak: "anywhere" }}>
              <span className=" uppercase underline">Note</span>: Value of
              option should be ({" "}
              <span className=" font-bold underline">
                typeName;color white|typeVerity;processor
                i3|typeStock;90|typePrice;100,
              </span>{" "}
              ) or copy and paste left formate and edit the value.
              <span className=" font-semibold">
                {" "}
                Be careful during setting the option{" "}
              </span>{" "}
              <span className=" font-bold">
                Because user only able to order that option.
              </span>
            </p>
            ...
            <div className="mt-2 flex flex-col">
              <div className="flex flex-col">
                <div>
                  ...
                  <p className=" text-[0.7rem] pl-2 ">
                    **Use this formate (typeName;color
                    white|typeVerity;processor i3|typeStock;90|typePrice;100)
                  </p>
                </div>
                ...
                <div>
                  {/* {makeTypesOfProductFormate(productOption).length > 0 ? (
                    ...
                    <div>
                      ...
                      <p>
                        👉color : white | processor : i3 | Stocks : 90 | Price :
                        ₹100
                      </p>
                      <p>
                        👉color : white | processor : i3 | Stocks : 90 | Price :
            ...
            <div>
              {thumbnailIndex !== -1 ? (
                imageInputBy === "by_url" ? (
                  <div className=" flex flex-col items-center">
                    ...
                    <img
                      ...
                      src={allImgUrls.split(",")[thumbnailIndex]}
                      alt=""
                    />
                ...
                <p className=" overline">
                  Give image and Select thumbnail image otherwise 0th image will
                  be thumbnail of product.
                </p>
              )}
            </div>
          ...
          <div>
            <p className=" text-center underline font-semibold my-1">
              NOTE : Read carefully all the gievn inputs.(Specially Discription
              of product and option for product.)
            </p>
