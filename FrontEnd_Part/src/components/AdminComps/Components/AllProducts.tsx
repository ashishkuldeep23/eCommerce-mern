...
function SingleUIData({ product }: { product: IProduct }) {
   ...
   const [arrOfOptions, setArrOfOptions] = useState<
      [TValueOfOptionBased, TValueOfOptionBased]
   >(["delete", "live"]);
   ...
   function selectForDeleteHandler(e: React.ChangeEvent<HTMLSelectElement>) {
      ...
      dispatch(
         updateProductAdmin(
            makeFormData({
               whatUpadte: "makeDelete",
               productId: product.id,
               isDeleted: makeDeleteVaue,
            }),
         ),
      );
   }
               ...
               <div
                  ...
                  <div className="flex min-w-0 gap-x-4">
                     ...
                     <div className="min-w-0 flex-auto">
                        <p className=" capitalize text-sm font-semibold leading-6">
                           {product.title}
                        </p>
                        <p className=" capitalize mt-0.5 truncate text-xs leading-4">
                           {product.brand}
                        </p>
                        <p className=" capitalize mt-0.5 truncate text-xs leading-4">
                           {product.category}
