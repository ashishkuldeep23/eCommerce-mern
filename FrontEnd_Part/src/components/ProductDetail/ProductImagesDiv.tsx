      ...
      <div className="  lg:w-3/5 flex flex-col justify-center items-center sm:flex-row-reverse">
         <div className="grid gap-1 grid-cols-1 grid-rows-1 place-content-center place-items-center  ">
            {arrOfImage.length > 0 && mainImg ? (
               <div className=" relative flex justify-center w-[90vw] sm:w-[60vw] md:w-[50vw] lg:w-[35vw]">
                  <button
                  ...
                  <img
                     ...
                     onClick={(e) => {
                        e.stopPropagation();
                        showModalWithValues(mainImg, singleProductData.title);
                     }}
                     onError={(e) => onImageErr(e)}
                     {...handlers}
                  />
            ...
            {arrOfImage.length > 0 ? (
               arrOfImage.map((image, i) => {
                  return (
                     <div
                        key={i}
                        className="w-[130px] h-[70px] sm:h-[100px] relative">
                        <img
                           onClick={(e) => {
                              e.stopPropagation();
                              setMainImg(image);
