...
export default function ProductDetails() {
    ...
    return (
        <div className="bg-white mx-auto max-w-full md:max-w-allAk px-1 md:px-2 lg:px-8">
            <div className="pt-6">
                ...
                <div className="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0  flex flex-col justify-center">
                        ...
                        <p className="text-3xl tracking-tight text-gray-900 text-center font-bold">{product.name}</p>
