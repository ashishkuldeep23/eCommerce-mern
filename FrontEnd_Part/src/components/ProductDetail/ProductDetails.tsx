...
export default function ProductDetails() {
   ...
   function productDislikeHandler(
      e: React.MouseEvent<HTMLParagraphElement, MouseEvent>,
   ) {
      e.stopPropagation();
   ...
   function addOrRemovetoWishListHandler(
   ...
   function shareLinkOfProduct() {
      ...
      let ChildrenOfModal = (
         <div>
               ...
               <button
                  ...
                  onClick={async () => {
                     ...
                     try {
                        ...
                        toast.success(
                           "URL copied successful. Paste it somewhere.",
                        );
            ...
            <p className="text-center mt-1 font-bold underline">
               ...
               <div className="pt-6 ">
                  ...
                  <div className="mx-auto max-w-2xl px-2 pt-10 sm:px-6 lg:max-w-7xl lg:grid-cols-2 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8  lg:pt-16  block lg:flex lg:items-start">
                     ...
                     <div className="mt-4 lg:row-span-3 flex flex-col justify-center lg:w-2/5 lg:ml-5 lg:mt-10">
                        ...
                        <div
                           ...
                           <LikeBtnDoubleClick
                              doubleClickLike={doubleClickLike}
                              left={false}
                           />

                           {/* Product name and price div */}
                           <div>
                              <p className="text-3xl tracking-tight  font-bold capitalize underline">
                                 {singleProductData && singleProductData.title}
                              </p>
                              ...
                              singleProductData.discountPercentage ? (
                                 <p
                                    className={`text-2xl text-start font-medium ${!themeMode ? "text-gray-900" : "text-gray-300"} `}>
                                    {" "}
                                 ...
                                 <p
                                    className={`text-lg text-end font-medium ${!themeMode ? "text-gray-900" : "text-gray-300"} `}>
                                    {" "}
                                    ₹
                                    {singleProductData &&
                                       singleProductData.price}{" "}
                           ...
                           <div className="flex items-center w-4/5 mt-5">
                              <p
                                 ...
                                 <i
                                    className={`ri-thumb-up-fill  ${singleProductData?.likedUserIds?.includes(userDataId) ? "text-blue-400" : "text-gray-300"} `}></i>{" "}
                                 {singleProductData?.likes || 0}
                              </p>
                              ...
                              <p
                                 ...
                                 onClick={(e) => {
                                    productDislikeHandler(e);
                                 }}>
                                 <i
                                    className={`ri-thumb-down-fill ${singleProductData?.dislikedUserIds?.includes(userDataId) ? "text-red-400" : "text-gray-300"} `}></i>{" "}
                                 {singleProductData?.dislikes || 0}
                              </p>
                        ...
                        <div className="mt-5">
                           ...
                           <button
                              ...
                              onClick={(e) => {
                                 e.preventDefault();
                                 e.stopPropagation();
                                 addOrRemovetoWishListHandler(e);
                              }}>
                              {userData.wishListIdsArr &&
                  ...
                  <div className="mx-auto max-w-2xl px-4 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8  lg:pt-16  ">
                     <div className="lg:col-span-2 lg:pr-8 ">
                        <h1 className="text-2xl font-bold tracking-tight sm:text-3xl capitalize underline">
                           {singleProductData &&
                              singleProductData.description?.fullName}
                        </h1>
                     </div>
                           ...
                           <div className="mt-10">
                              ...
                              <div className="mt-4">
                                 <ul
                                    ...
                                    {singleProductData &&
                                    singleProductData.description?.highLights
                                       .length ? (
                                       singleProductData &&
                                       singleProductData.description?.highLights.map(
                                          (highlight, i) => (
                                             <li key={i}>
                                                <span>{highlight}</span>
                                             </li>
                           ...
                           <div className="mt-10">
                              ...
                              <div className="mt-4">
                                 <table>
                                    <tbody>
                                       {singleProductData &&
                                          singleProductData.description?.specifications.map(
                                             (specs, i) => (
                                                <tr
                                                   className=" border-b"
                                                   key={i}>
                           ...
                           <div className="mt-10">
                              ...
                              <div className="mt-4">
                                 <table>
                                    <tbody>
                                       {singleProductData &&
                                          singleProductData.description?.product_Details.map(
                                             (specs, i) => (
                                                <tr
                                                   className=" border-b"
                                                   key={i}>
                           ...
                           <div className="mt-10">
                              ...
                              <div className="mt-4">
                                 <table>
                                    <tbody>
                                       {singleProductData &&
                                          singleProductData.description?.dimensions.map(
                                             (specs, i) => (
                                                <tr
                                                   className=" border-b"
                                                   key={i}>
                  ...
                  <div className="mx-auto max-w-2xl  pb-16 sm:px-6  lg:max-w-7xl w-full   ">
                     <div
                        className={`${!themeMode ? "bg-white text-gray-700" : "bg-black text-gray-100"} pr-0`}>
                        <div className="mx-auto px-0  lg:px-4  lg:max-w-7xl flex flex-col ">
                           <h1 className="text-xl  my-5 font-bold underline">
                              Simmilar products
                           </h1>
