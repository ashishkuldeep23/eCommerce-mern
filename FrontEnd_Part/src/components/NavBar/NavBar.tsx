                ...
                <>
                    <div className=" mx-auto max-w-full md:max-w-allAk px-1 md:px-2 lg:px-8 ">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            {/* This div will visiable on less then lg devices */}
                            <div className="absolute inset-y-0 left-0 flex items-center lg:hidden" onClick={() => { navigatetabs("/"), { replace: true } }}>
                            ...
                            <div className="flex flex-1 items-center justify-center lg:items-stretch lg:justify-start">
                                ...
                                <div className=" hidden lg:flex flex-shrink-0 items-center  " onClick={() => { navigatetabs("/"), { replace: true } }} >
                                    <img
                                        className="h-8 w-auto"
                                        src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500"
                                        alt="Your Company"
                                    ...
                                    <div className="flex space-x-4">
                                        {navigation.map((item, i) => (
                                            <a
                                                key={i}
                                                href={item.href}
                                                className={` ${item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'} rounded-lg px-3 py-2 text-lg font-medium `}
                                        ...
                                        <div className='my-auto '>
                                            ...
                                            <button className='text-white mx-1 px-3 py-2 rounded text-lg font-medium  hover:bg-gray-700 hover:text-white'>Serch</button>
                                        </div>
                                        ...
                                        <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-lg bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                            <Menu.Item>
                                                {({ active }) => (
                                                    <Link
                                                        to="/about"
                                                        className={`${active ? 'bg-gray-100' : ''} block px-4 py-2 text-lg text-gray-700`}
                                                    >
                                                        Your Profile
                                                    </Link>
                                                )}
                        ...
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            ...
                            {navigation.map((item, i) => (
                                <Disclosure.Button
                                    ...
                                    as="a"
                                    href={item.href}
                                    className={`${item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'} block rounded-lg px-3 py-2 text-base font-medium `}
