...
import { mainVerifyMail, userState } from "../../Slices/UserSlice"
...
export const VerifyMail = () => {
    ...
    const { isFullFilled, userData, isLoading, errMsg } = userState()
    ...
    useEffect(() => {
        ...
        if (token && email) {
            ...
            let sendBody = { email: email, token: token }

            console.log(sendBody)


            dispatch(mainVerifyMail(sendBody))
        }
            ...
            >
                <div className=" h-allAk mx-auto max-w-full lg:max-w-allAk px-1 lg:px-8 flex flex-col items-center pt-40">
                    ...
                    <div className="border p-2 rounded text-center flex flex-col items-center justify-center">
                        ...
                        <img className="w-32 h-32 my-3" src={userData.profilePic} alt={userData.firstName} />
