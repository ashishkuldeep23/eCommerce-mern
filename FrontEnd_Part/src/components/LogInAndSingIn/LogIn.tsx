...
export default function LogIn() {
   ...
   return (
      <>
         ...
         <div
            className={` ${isLoading && "opacity-75"} flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8  h-allAk ${!themeMode ? "bg-white text-black" : " bg-black text-white "}  `}>
