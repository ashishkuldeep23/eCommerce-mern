...
const GoogleBtnLogic = () => {
   ...
   function googleLogIn() {
      ...
      window.open(
         `${import.meta.env.VITE_BACKEND_URL}/userLoginGoogle`,
         "_self",
      );
   }
   ...
   return (
      <>
         <div className=" my-2 text-center flex justify-center">
            {/* <hr /> */}
            <p className="text-xs font-semibold border-2 rounded-full p-1.5 border-sky-500 text-sky-500 ">
               OR
            </p>
         </div>
         ...
         <div
            ...
            <button className="bg-red-500 px-2 rounded text-lg text-white font-bold">
         ...
         <div
            className="flex justify-center my-1"
            onClick={() => {
               defultUserClickHandler();
            }}>
            <button className=" bg-indigo-500 px-2 rounded text-lg text-white font-bold">
