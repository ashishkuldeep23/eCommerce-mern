            ...
            >
...

                {
                    ...
                    >
                        ...
                        <p className="mb-5 text-red-500">Click on image and make profile picture.</p>
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
...

                            {
                                ...
                                getUserData.allImages.map((img, i) => {
                                    return (
                                        <div    
                                            key={i}
                                            onClick={(e) => { e.stopPropagation(); makeThisProfilePic(img) }}
                                            className=" relative hover:scale-110  hover:cursor-pointer hover:z-10"
                                            id="user_single_img"
                                        >
