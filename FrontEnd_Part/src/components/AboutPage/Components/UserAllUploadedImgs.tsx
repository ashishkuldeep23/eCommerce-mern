...
export function UserAllUploadedImgs() {
   ...
   function showModalWithValues(userImage: string) {
      let ChildrenOfModal = (
         <div>
            <img className=" w-80 rounded" src={userImage} alt="" />
            <button
   ...
   return (
      <>
         <div className=" text-center px-1 p-2 pt-16 relative">
            {/* Loader code -------> */}
            ...
            {/* <h1 className=" text-xl  underline text-blue-500">
            ...
            <div className=" flex flex-wrap justify-center md:justify-start items-center gap-3">
               {getUserData.allImages && getUserData.allImages?.length > 0 ? (
                     ...
                     return (
                        <div
                           ...
                           <button
                              ...
                              className="   rounded-b text-white font-serif font-thin bg-green-700 w-full">
                              Make Profile Pic
                           </button>
                        </div>
                     );
